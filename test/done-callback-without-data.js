// Test with done callback that does not return data

var pull = require('pull-stream')
var Spec = require('pull-spec');
var tape =  require('tape')
var asyncMap = require('../');
tape('normal case with done callback', function (t) {
...
tape('done callback error is propagated', function(t) {
  var doneCalled = false;
...
tape("original error takes precedence over done callback error", function(t) {
  ...
  pull(
    ...
    function done(err, cb) {
      ...
      return Promise.reject(new Error("done callback error"));
    }),
    pull.collect(function(err, five) {
